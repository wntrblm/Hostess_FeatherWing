...
#define CONNECTED_LED_PIN GPIO(GPIO_PORTA, 3)
#define READ_LED_PIN GPIO(GPIO_PORTA, 5)
#define WRITE_LED_PIN GPIO(GPIO_PORTA, 7)
#define PA10 GPIO(GPIO_PORTA, 10)
#define PA11 GPIO(GPIO_PORTA, 11)
#define PA12 GPIO(GPIO_PORTA, 12)
#define VUSB_EN_PIN GPIO(GPIO_PORTA, 15)
#define VBUS_FAULT_PIN GPIO(GPIO_PORTA, 16)
